...
<section class="hero-area">
    <div class="container-solid">
        <div class="page_tital">
            <h1 class="title"><?php echo!empty($project_details[0]['project_title']) ? $project_details[0]['project_title'] : ''; ?></h1>
        </div>
    </div>
</section>
<!--end: slider-->
...
<!--            <div class="page_nav">
                <ul>
                    ...
                    <li><a href="<?php echo base_url() . 'projects'; ?>">Projects </a><span>/</span></li>
                    <li><?php echo!empty($project_details[0]['project_title']) ? $project_details[0]['project_title'] : ''; ?></li>
                </ul>
            </div>-->
  ...
  <div class="event_location"> <i class="fa fa-map-marker"></i> <span>Location:</span>
                 <?=!empty($project_details[0]['location'])?$project_details[0]['location']:'';?></div>
  ...
  <!--              <div class="subtital">
                    <h4><?php echo!empty($project_details[0]['project_title']) ? $project_details[0]['project_title'] : ''; ?></h4>
                </div>-->
<!--                <p> 
                    <img src="<?= !empty($project_details[0]['image']) ? file_exists($this->config->item('project_img_big_path') . $project_details[0]['image']) ? $this->config->item('project_big_img_url') . $project_details[0]['image'] : base_url('images/no_image.jpg') : base_url('images/no_image.jpg') ?>" alt="" class="right_img"> 
                </p>-->
                <p><?php echo!empty($project_details[0]['description']) ? $project_details[0]['description'] : ''; ?></p>
