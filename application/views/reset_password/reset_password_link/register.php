...
<h1 id="site-logo"><img src="<?php echo $this->config->item('base_url');?>images/logo.png" alt="<?=$this->config->item('sitename')?>" /></h1>
</div ><!--close logo-->
</div ><!--top head-->
...
<p>You have successfully registerd with <?=$this->config->item('sitename')?> account.</p><p><a href="<?=$actdata['loginLink'];?>">Click here</a> to Login with your credentials.</p>
