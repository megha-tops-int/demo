                  ...
                  <div class="col-xs-12 col-sm-8 col-md-8">
                    <div class="dataTables_filter" id="DataTables_Table_0_filter">
                      <label>
                        ...
                        <input type="text" name="searchtext" id="searchtext" aria-controls="DataTables_Table_0" placeholder="Search project title, type, location..." title="Search project title, type, location..." value="<?=!empty($searchtext)?$searchtext:''?>">
