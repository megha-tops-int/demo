...
$project_id = $this->router->uri->segments[4];
$path_comman_delete = $this->config->item('admin_base_url') . $viewname . '/';
$path_comman = $this->config->item('admin_base_url').$viewname.'/feedback/'.$project_id.'/';
          ...
          <div class="portlet-content">
            <!--<div class="row">-->
                    <div class="col-sm-12">
                       ...
                       <div class="col-sm-2">
                           <a class="btn btn-default howler" title="Details" href="<?= base_url('admin/' . $viewname . '/view_record') . '/' . $project_id; ?>">Details</a>
                       </div>
                       <div class="col-sm-6">
                           <a class="btn btn-primary howler" title="Feedback" href="<?= base_url('admin/' . $viewname . '/feedback') . '/' . $project_id; ?>">Feedback</a> 
                       </div>
                   </div>
...
<script>
	...
	$('body').on('click','#selecctall',function(e){
	 ...
	 $('#allcheck').click(function(){
		...
		if(val != '')
    	{
    		delete_all_feedback_multipal(val,'<?=$path_comman_delete?>','<?=$project_id?>');	
    	}
    	else
    	{
