            ...
            <div class="col-md-12">
                <div class="portlet">
                    <div class="portlet-header">
                        <h3> <i class="fa fa-calendar-check-o"></i><?= $sub_title." - "; ?><?= !empty($editRecord[0]['first_name']) ? $editRecord[0]['first_name'] : ''; ?> <?= !empty($editRecord[0]['last_name']) ? $editRecord[0]['last_name'] : ''; ?></h3>
