            ...
            <div class="table-responsive">
              <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-8">
                    <div class="dataTables_filter" id="DataTables_Table_0_filter">
                      <label>
                        ...
                        <input type="text" name="searchtext" id="searchtext" aria-controls="DataTables_Table_0" placeholder="Search event name, organizers, location..." title="Search event name, organizers, location..." value="<?=!empty($searchtext)?$searchtext:''?>">
                ...
                <div class="row dt-rt">
                  ...
                  <div class="col-sm-2"> <a class="btn  pull-right btn-success howler" title="<?=$this->lang->line('add_record')?>" href="<?=base_url('admin/'.$viewname.'/add_record');?>">Add new <?=  strtolower($sub_title);?>
                    </a> </div>
                </div>
                <div id="common_div">
