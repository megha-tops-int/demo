            ...
            <div class="col-md-12">
                <div class="portlet">
                    <div class="portlet-header">
                        <h3> <i class="fa fa-calendar-check-o"></i><?=$head_title_1?> - <?php echo !empty($editRecord[0]['event_name'])?$editRecord[0]['event_name']:'';?></h3>
                        ...
                        <div class="col-sm-8">
                            <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname; ?>" id="<?php echo $viewname; ?>" method="post" accept-charset="utf-8" action="<?= $this->config->item('admin_base_url') ?><?php echo $path ?>" >
                                <div class="form-group">
                                    ...
                                    <span><?= !empty($editRecord[0]['event_name']) ? htmlentities($editRecord[0]['event_name']) : ''; ?></span>
                                
                                </div>
                                
                               <div class="row form-group">
                                <div class="col-sm-4">
                                    <label for="select-multi-input">Date</label><br>
                                    <span><?php if (!empty($editRecord[0]['event_date']) && $editRecord[0]['event_date'] != '0000-00-00 00:00:00' && $editRecord[0]['event_date'] != '1970-01-01 00:00:00'){ echo date(COMMAN_ONLY_DATE_FORMATE_VIEW, strtotime($editRecord[0]['event_date']));}?></span>
                                    
                                </div>
                                <div class="col-sm-4"> 
                                    <label for="select-multi-input">Time</label><br>
                                    <span><?php if (!empty($editRecord[0]['from_time']) && $editRecord[0]['from_time'] != '00:00:00' && $editRecord[0]['from_time'] != '00:00:00'){ echo date(COMMAN_TIME_FORMATE_VIEW, strtotime($editRecord[0]['from_time']));}?> <b>TO</b>
                                    
                                    <?php if (!empty($editRecord[0]['to_time']) && $editRecord[0]['to_time'] != '00:00:00' && $editRecord[0]['to_time'] != '00:00:00'){ echo date(COMMAN_TIME_FORMATE_VIEW, strtotime($editRecord[0]['to_time']));}?>
                                ...
                                <div class="form-group add_image_div">
                                    ...
                                    <p> <span class="txt">&nbsp;</span>
                                      ...
                                      <?php } else { 
                                              //echo "em";
                                              if(!file_exists($this->config->item('event_img_big_path').$editRecord[0]['image'])){
                                                ?>
                                      <img id="uploadPreview1" class="noimage" src="<?=base_url('images/no_image.jpg')?>"  width="100" />
                                      <?php }
                                            else
                                            { 
                                              ?>
                                      <img class="img-responsive" id="uploadPreview1" src="<?=$this->config->item('event_big_img_url').$editRecord[0]['image'] ?>" style="width:360px;" />
                                      <?php } }  ?>
                                      <?php } ?>
                                      </p>
                                ...
                                <div class="form-group add_image_div">
                                    <label for="select-multi-input">Logo</label>
                                    ...
                                    <p> <span class="txt">&nbsp;</span>
                                      ...
                                      <?php } else { 
                                              //echo "em";
                                              if(!file_exists($this->config->item('event_logo_img_big_path').$editRecord[0]['logo'])){
                                                ?>
                                      <img id="uploadPreview1" class="noimage" src="<?=base_url('images/no_image.jpg')?>"  width="100" />
                                      <?php }
                                            else
                                            { 
                                              ?>
                                      <img class="img-responsive" id="uploadPreview1" src="<?=$this->config->item('event_logo_big_img_url').$editRecord[0]['logo'] ?>" style="height: 65px; width:65px;"/>
                                      <?php } }  ?>
                                      <?php } ?>
                                      </p>
                                ...
                                <div class="form-group">
                                    <label for="select-multi-input"><?= $this->lang->line('organizers') ?></label><br>
                                    <span><?= !empty($editRecord[0]['organizer']) ? $editRecord[0]['organizer'] : ''; ?></span>
                                 
                                </div>
                                
                                <div class="form-group">
                                    <label for="select-multi-input"><?= $this->lang->line('location') ?></label><br>
                                    <span><?= !empty($editRecord[0]['location']) ? $editRecord[0]['location'] : ''; ?></span>
                                </div>
