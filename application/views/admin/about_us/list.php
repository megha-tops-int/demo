                  ...
                  <div class="col-xs-12 col-sm-8 col-md-8">
                    <div class="dataTables_filter" id="DataTables_Table_0_filter">
                      <label>
                        ...
                        <input type="text" name="searchtext" id="searchtext" aria-controls="DataTables_Table_0" placeholder="Search pillar name, description..." title="Search pillar name, description..." value="<?=!empty($searchtext)?$searchtext:''?>">
                        ...
                        <button class="btn btn-success howler flt" title="<?php echo $this->lang->line('view_all');?>" onclick="clearfilter_data('<?=$path_comman?>')"> View all </button>
                      </label>
                    </div>
                  </div>
                </div>
