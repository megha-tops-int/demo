    ...
    */
    this.messages = {
      ...
      , type: {
          ...
          , map_url:    "This value should be a valid url [http://xyz.com]."
          , phone_number:  "This value should be a valid phone number (xxx-xxx-xxxx)."
          , urlstrict:  "This value should be a valid url."
          , number:     "This value should be a valid number."
		  , number_mask:"Please enter valid phone number.(xxx-xxx-xxxx)"
          , digits:     "This value should be digits."
          , dateIso:    "This value should be a valid date (YYYY-MM-DD)."
          , alphanum:   "This value should be alphanumeric."
          , phone:      "This value should be a valid phone number."
          , latitude:   "This value shoud be a valid latitude (-90.0 to 90.0)."
          , longitude:   "This value shoud be a valid longitude (-180.0 to 180.0)."
        }
      ...
      , type: function ( val, type ) {
        ...
        switch ( type ) {
          ...
          case 'url':
            ...
            /* falls through */
            case 'map_url':
            regExp = /^(http|https)\:\/\/[a-z\d\-\.]+\.[a-z]{2,3}(:[a-z\d]*)?\/?([a-z\d\-\._\?\,\'\/\\\+&amp;%\$#\=~])*$/i;
          case 'urlstrict':
        ...
        case 'phone_number':
            ...
            break;
            case 'latitude':
                regExp = /^-?([1-8]?[0-9]\.{1}\d{1,6}$|90\.{1}0{1,6}$)/;
                //regExp = /^-?([1-8]?[1-9]|[1-9]0)\.{1}\d{1,6}/;
                break;
            case 'longitude':
                //regExp = /[-]?1[0-7][0-9]\.\d+|[-]?[0-9]?[0-9]\.\d+|[-]?180\.0+?)$/;
                regExp = /^-?([1]?[1-7][1-9]|[1]?[1-8][0]|[1-9]?[0-9])\.{1}\d{1,6}/;
                break;
