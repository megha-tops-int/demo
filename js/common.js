...
{      
  $.confirm({'title': 'CONFIRM','message': " <strong> Are you sure want to delete "+"'"+id+"'<strong>?</strong>",'buttons': {'Yes': {'class': 'special','action': function(){window.location= url;}},'No'	: {'class'	: ''}}});
}
/*
